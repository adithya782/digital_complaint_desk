...
function handleLocationModeChange() {
  const selectedMode = document.querySelector(
    'input[name="locationMode"]:checked',
  ).value;
  ...
  if (selectedMode === "current") {
    ...
    statusText.textContent =
      "Click the location button to capture your device position.";
    ...
    statusText.textContent =
      "Interactive Map Active. Pin your coordinates below.";
...
function initializeInteractiveMap() {
  ...
  mapInstance.on("click", function (e) {
    ...
    document.getElementById("locationStatus").textContent =
      "Map coordinates pinned successfully!";
...
function getAutomaticLocation() {
  ...
  navigator.geolocation.getCurrentPosition(
    ...
    function (error) {
      statusText.textContent =
        "Could not track current position automatically. Please mark on map instead.";
      statusText.style.color = "#e53935";
